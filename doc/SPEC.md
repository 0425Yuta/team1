...
|          | less   | 0x2005 |      | スタックから値を2つpopし、上の値が大きければ0、小さければ1をpushする                    |
|          | eq     | 0x2006 |      | スタックから値を2つpopし、等しければ1、そうでなければ0をpushする                        |
|          | neq    | 0x2007 |      | スタックから値を2つpopし、等しければ0、そうでなければ1をpushする                        |
|          | and    | 0x2008 |      | スタックから値を2つpopし、その値のANDをpushする                                         |
|          | or     | 0x2009 |      | スタックから値を2つpopし、その値のORをpushする                                          |
|          | xor    | 0x200a |      | スタックから値を2つpopし、その値のXORをpushする                                         |
|          | not    | 0x200b |      | スタックから値を1つpopし、その値のビットを全て反転させpushする                          |
